...
import CoupleCourierCell from './pages/couples/CoupleCourierCell';
import CoupleMDMCell from './pages/couples/CoupleMDMCell';
import ManageGateway from './pages/manage/ManageGateway';
import ManageUser from './pages/manage/ManageUser';
import FaultReport from './pages/fault/FaultReport';
...
export const defaultRoutes: IRoute[] = [
  {
    path: '/couplecouriercell',
    component: CoupleCourierCell
  },
  {
    path: '/couplemdmcell',
    component: CoupleMDMCell
  },
  {
    path: '/manageuser',
